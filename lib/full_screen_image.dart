...
class FullScreenWidget extends StatelessWidget {
  ...
  FullScreenWidget({@required this.child, this.backgroundColor = Colors.black,
...
class FullScreenPage extends StatefulWidget {
  ...
  FullScreenPage({@required this.child, this.backgroundColor = Colors.black, this.backgroundIsTransparent = true,
